...
export default function MatchFiltersDrawer({
  ...
  return (
    <div className="match-filters-drawer__overlay" onClick={onClose}>
      <div className="match-filters-drawer__sheet" onClick={(e) => e.stopPropagation()}>
        <div className="match-filters-drawer__header">
          <h2 className="match-filters-drawer__title">{t('MATCHES_FILTERS_TITLE')}</h2>
          <button className="match-filters-drawer__close" onClick={onClose} aria-label="Close">
        ...
        <div className="match-filters-drawer__body">
          <div className="match-filters-drawer__section">
            <h3 className="match-filters-drawer__section-title">{t('MATCHES_FILTERS_STATUS')}</h3>
          ...
          <div className="match-filters-drawer__section">
            <h3 className="match-filters-drawer__section-title">{t('MATCHES_FILTERS_STAGE')}</h3>
            <div className="match-filters-drawer__options">
          ...
          {stage === 'group' ? (
            <div className="match-filters-drawer__section">
              <h3 className="match-filters-drawer__section-title">{t('MATCHES_FILTERS_GROUP')}</h3>
              <div className="match-filters-drawer__options">
            ...
            <div className="match-filters-drawer__section">
              <h3 className="match-filters-drawer__section-title">{t('MATCHES_FILTERS_ROUND')}</h3>
              <div className="match-filters-drawer__options">
          ...
          <div className="match-filters-drawer__section">
            <h3 className="match-filters-drawer__section-title">{t('MATCHES_FILTERS_DATE')}</h3>
            <div className="match-filters-drawer__options">
              <button
